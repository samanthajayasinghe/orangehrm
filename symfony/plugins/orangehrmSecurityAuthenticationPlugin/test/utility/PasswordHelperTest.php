...
class PasswordHelperTest extends PHPUnit\Framework\TestCase {
    ...
    public function testIsPasswordStrongWithEnforcement(){
        $this->securityAuthConfigService = $this->getMockBuilder('SecurityAuthenticationConfigService')
            ->setMethods(array('isPasswordStengthEnforced','getRequiredPasswordStength'))
            ->getMock();
    ...
    public function testGetColorClass(){
        ...
        $strengths = array("veryWeak", "weak", "better", "medium", "strong", "strongest");
        $this->securityAuthConfigService = $this->getMockBuilder('SecurityAuthenticationConfigService')
            ->setMethods(array('getPasswordStrengths'))
            ->getMock();
